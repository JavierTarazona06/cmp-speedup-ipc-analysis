...
\hline
\end{tabular}
\caption{Cycles d'exécution obtenus pour Q9 (size=64).}
\label{tab:q9-cycles}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{../../results/images/q9_cycles_3d.png}
\caption{Graphe 3D des cycles (X=threads, Y=voies/o3-width, Z=cycles).}
